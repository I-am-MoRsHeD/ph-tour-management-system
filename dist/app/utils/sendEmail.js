...
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, templateName, templateData, attachments }) {
    try {
        ...
        const htmlContent = yield ejs_1.default.renderFile(templatePath, templateData);
        ...
        console.log("email sending error", error === null || error === void 0 ? void 0 : error.message);
