...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.User.create(Object.assign({ email, password: bcryptedPassword, auths: [authProvider] }, rest));
    return user;
});
...
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (decodedToken.role === user_interface_1.Role.USER || decodedToken.role === user_interface_1.Role.GUIDE) {
        if (decodedToken.userId !== userId) {
            throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "You are not permitted to do this!!");
        }
        ;
    }
    ;
