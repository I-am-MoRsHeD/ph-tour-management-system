...
router.post('/register', (0, validateSchema_1.validateSchema)(user_validation_1.createUserZodSchema), user_controller_1.UserControllers.createUser);
...
router.patch('/:id', (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), (0, validateSchema_1.validateSchema)(user_validation_1.updateUserZodSchema), user_controller_1.UserControllers.updateUser);
