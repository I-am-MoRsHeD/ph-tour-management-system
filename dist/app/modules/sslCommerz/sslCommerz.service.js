...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield payment_model_1.Payment.updateOne({ transactionId: payload.tran_id }, { paymentGatewayData: res.data }, { runValidators: true });
    }
    catch (error) {
        console.log(error);
...
exports.SSLServices = { sslPaymentInit, validatePayment };
