...
divisionSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (this.isModified("name")) {
            const baseSlug = (_a = this.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().split(" ").join("-");
...
divisionSchema.pre('findOneAndUpdate', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (division === null || division === void 0 ? void 0 : division.name) {
            const baseSlug = (_a = division.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().split(" ").join("-");
            let slug = `${baseSlug}-division`;
            // optional,,jodi by any change mongoose er validation failed kore,taile eikane ashe atkai jabhe!eita na korleo emnitei slug uniquely set hobe
            let counter = 0;
            while (yield exports.Division.exists({ slug })) {
